...
namespace slock4net.Commands
{
    interface ICommand
    {
        ...
        public const int TIMEOUT_FLAG_PUSH_SUBSCRIBE = 0x0020;
        public const int TIMEOUT_FLAG_MINUTE_TIME = 0x0040;
        public const int TIMEOUT_FLAG_REVERSE_KEY_LOCK_WHEN_TIMEOUT = 0x0080;
        public const int TIMEOUT_FLAG_UNRENEW_EXPRIED_TIME_WHEN_TIMEOUT = 0x0100;
        public const int TIMEOUT_FLAG_LOCK_WAIT_WHEN_UNLOCK = 0x0200;
        public const int TIMEOUT_FLAG_MILLISECOND_TIME = 0x0400;
        public const int TIMEOUT_FLAG_LOG_ERROR_WHEN_TIMEOUT = 0x0800;
        public const int TIMEOUT_FLAG_REQUIRE_ACKED = 0x1000;
        public const int TIMEOUT_FLAG_UPDATE_NO_RESET_TIMEOUT_CHECKED_COUNT = 0x2000;
        public const int TIMEOUT_FLAG_KEEPLIVED = 0x8000;

        public const int EXPRIED_FLAG_PUSH_SUBSCRIBE = 0x0020;
        public const int EXPRIED_FLAG_MINUTE_TIME = 0x0040;
        public const int EXPRIED_FLAG_REVERSE_KEY_LOCK_WHEN_EXPRIED = 0x0080;
        public const int EXPRIED_FLAG_ZEOR_AOF_TIME = 0x0100;
        public const int EXPRIED_FLAG_UNLIMITED_AOF_TIME = 0x0200;
        public const int EXPRIED_FLAG_MILLISECOND_TIME = 0x0400;
        public const int EXPRIED_FLAG_LOG_ERROR_WHEN_EXPRIED = 0x0800;
        public const int EXPRIED_FLAG_AOF_TIME_OF_EXPRIED_PARCENT = 0x1000;
        public const int EXPRIED_FLAG_UPDATE_NO_RESET_EXPRIED_CHECKED_COUNT = 0x2000;
        public const int EXPRIED_FLAG_UNLIMITED_EXPRIED_TIME = 0x4000;
        public const int EXPRIED_FLAG_KEEPLIVED = 0x8000;
